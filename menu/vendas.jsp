    ...
    <script>  
   	...
   	function enviar(par){  
         ...
         if (document.cadastro.ven_codigoField.value == ''){  
            ...
            document.cadastro.statusField.value = 'Preencha o codigo do funcionario';  
            ...
            document.cadastro.statusField.value = 'Preencha a data da compra'; 
