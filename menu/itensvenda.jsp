       ...
       <script>  
         ...
         function enviar(par){  
            ...
            if (document.cadastro.itensvenda_codigoField.value == ''){  
               ...
               document.cadastro.statusField.value = 'Preencha o codigo de venda';  
               ...
               document.cadastro.statusField.value = 'Preencha o codigo de funcionario';
        ...
        <tr>  
          <td height="" bgcolor="red"><p> <strong>Codigo :</strong>  
             ...
             <input name="tpg_codigoField" type="text" id="tpg_codigoField" size="" value="<%=(tpg_codigo==null)?"":tpg_codigo%>"> </p>
               <p> <strong>Codigo Funcionário :</strong>  
             <input name="fun_codigoField" type="text" id="fun_codigoField" size="" value="<%=(fun_codigo==null)?"":fun_codigo%>"> </p> 
               <p><strong>Embalagem :</strong>  
             <input name="itv_embalagemField" type="text" id="itv_embalagemField" size="" value="<%=(itv_embalagem==null)?"":itv_embalagem%>"> </p>  
             ...
             <input name="itv_descField" type="text" id="itv_descField" size="" value="<%=(itv_desc==null)?"":itv_desc%>"> </p>  
               <p> <strong>Valor Total :</strong>  
             <input name="itv_valortotalField" type="text" id="itv_valortotalField" size="" value="<%=(itv_valortotal==null)?"":itv_valortotal%>"> </p> 
