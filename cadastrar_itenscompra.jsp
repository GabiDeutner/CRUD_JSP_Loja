...
<%      
   try {  
      ...
      con.setCom_codigo(request.getParameter("com_codigoField"));  
      ...
      if(request.getParameter("itenscompra_codigoField").equals(temp.getString("itenscompra_codigo")))  
         response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itenscompra.jsp?status=Registro ja existente");  
